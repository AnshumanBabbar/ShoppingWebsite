  ...
  <h3>Choose Payment Mode</h3>
            ...
            <ul class="nav nav-tabs">
             ...
             <div class="tab-content">
                ...
                <div id="cards" class="tab-pane fade show active">
                    ...
                    <input onclick="payment()" id="btnCardPayment" type="button" value="Confirm" />
                ...
                <div id="cod" class="tab-pane fade">
                    ...
                    <p>   
                        <input onclick="payment2()" id="btnCOD" type="button" value="Confirm" /></p>
                </div>
            </div>
    ...
    <script>
        function payment() {
            ...
            var c = window.confirm("CONFIRM PAYMENT");
            if (c == true) {
                ...
                for (var i = 0; i < 10; i++) {
                    ...
                    if (x > 9) {
                        x = parseInt(x % 10)
                        code = code + "" + possible[x] + "";
                    }
                    else { code = code + "" + possible[x] + ""; }
                }
                alert("your transacaction code is" + code);
            ...
            function payment2() {
                ...
                if (c == true) {
                    ...
                    alert("your transacaction code is" + code);
                    alert("You are confirmed for COD,");
