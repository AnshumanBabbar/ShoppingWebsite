...
<body>
    <form id="form1" runat="server">
     ...
     <div class ="navbar navbar-default navbar-fixed-top mynav" role ="navigation">
            <div class ="container ">
                <div class ="navbar-header">
                    ...
                    <a class="navbar-brand" href="Default.aspx"> <span> <img src="icons/shoplogo.png" alt="img" height="50"  /></span> Shopping Arena </a> 
                </div>
...
An edge-to-edge OLED display. Ceramic Shield with four times better drop performance. And Night mode on every camera. iPhone 12 has it all — in two perfect sizes.</p>
                   ...
                   <div class="col-lg-4">
                    ...
                    <h2>Footwear</h2>
                    <p>We’re the cool vegan footwear brand you’ve been searching for. Our aim is to push creativity throughout all outlets, including the design and all aspects of our brand.

Stop your scrollin’. Because your search for that vegan-but-still-cool footwear brand - that’s been going on for way too long now - is over. Being vegan is cool, duh.</p>
                    <p> <a class="btn btn-default " href="#" role="button" >View More &raquo; </a>  </p>
                </div>
                   ...
                   <div class="col-lg-4">
                    ...
                    <h2>Tshirt</h2>
                    <p>With the trendiest, freshest, and most unique styles from across the world, We invite you to express your personal style fearlessly, and with a confidence and optimism that cannot be easily shaken.</p>
                    <p> <a class="btn btn-default " href="#" role="button" >View More &raquo; </a>  </p>
                </div>
